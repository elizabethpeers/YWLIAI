...
def train_network():
    ...
    model.fit_generator(train_generator, steps_per_epoch=int(2700 / batch_size), epochs=epochs,
                        validation_data=test_generator,
                        validation_steps=int(600 / batch_size), callbacks=[checkpoint, lr_scheduler])
